...
\begin{itemize}
  \item En la entidad calificación las valoraciones van de 1 a 10.
  \item Tanto para Categoria Producto, Tipo Servicio, Categoria Empresa las subcategorias de las mismas no deben tener ciclos. 
  \item Dentro de Tipo de Publicacion estan tanto RubíDeOriente, Oro, Plata, Bronce y Libre!. Y Ademas cumplen las restricciones del enunciado respecto a porcentajes y prioridad en las busquedas.
